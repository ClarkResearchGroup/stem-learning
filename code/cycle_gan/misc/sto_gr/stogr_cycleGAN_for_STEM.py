...
exp_dir_raw = parent_dir + "data/{}/{}_{}/exp_1K/".format(mat, mat, num)
sim_dir_raw = parent_dir + "data/{}/{}_{}/sim_1K/".format(mat, mat, num)
...
identifier = "20220609_MODEL_unet_dist_gen_fft_10_SIM_pristine_gaussian_{}_EXP_{}_{}".format(gaussian, mat, num)
